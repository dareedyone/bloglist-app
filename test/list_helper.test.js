...
describe("total likes", () => {
	...
	test("when list has only one blog equals to the like of that", () => {
...
describe("favorite blogs", () => {
	test("of empty list is undefined", () => {
		expect(favoriteBlog(listWithZeroBlog)).toBe(undefined);
	});
...
describe("most blogs", () => {
	test("of empty list is undefined", () => {
		expect(mostBlogs(listWithZeroBlog)).toBe(undefined);
	});
